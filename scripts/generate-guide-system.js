  ...
  },
  {
    ...
    html: GuideLayout({
      ...
      sections: [
        ...
        GuideSection({
          id: "entradaYVisado",
          title: "Planificar el paso de la entrada",
          children: `<p>La entrada es sobre todo una cuestión de secuencia y encaja junto a la decisión de "mudarse juntos o reunirse más tarde". Para la mayoría de las familias la pregunta práctica no es <em>si</em> el familiar no comunitario puede venir, sino si puede viajar primero y presentar la solicitud después, o si hay que pasar por un consulado antes de reservar un vuelo. Todo depende de una variable: la nacionalidad del familiar.</p>
          <table class="guide-table"><tbody>
            <tr><th>Situación</th><td><strong>Qué implica para la secuencia</strong></td></tr>
            <tr><th>El pasaporte permite estancias cortas sin visado</th><td>El familiar puede llegar primero y presentar la solicitud de tarjeta de residencia después de aterrizar, sin depender de un consulado. La presentación se hace en España, en la oficina de extranjería de la provincia donde vaya a vivir la familia, o en la comisaría designada si esa provincia lo canaliza así. Hay un plazo de tres meses desde el día de entrada, y el resguardo que se entrega al presentar cubre la estancia mientras se fabrica la tarjeta.</td></tr>
            <tr><th>El pasaporte exige visado</th><td>Primero hay un paso consular, así que el registro del propio ciudadano de la UE y la cita del familiar deben planificarse en torno a él. Aun así no es un visado de turista ordinario: las normas de la UE obligan a los estados miembros a tramitar a los familiares directos de ciudadanos de la UE sin cobrar tasa y por una vía más rápida que la ordinaria.</td></tr>
            <tr><th>El familiar ya tiene tarjeta de familiar de la UE</th><td>Una tarjeta ya expedida por esta vía en otro estado miembro elimina por completo la cuestión del visado de entrada, así que desaparece la restricción de secuencia.</td></tr>
          </tbody></table>
          <div class="guide-box guide-box--info"><strong>Por qué difiere de la reagrupación ordinaria</strong><p>En la vía estándar de reagrupación, un reagrupante residente presenta la solicitud en España y después el familiar recoge un visado en el extranjero antes de viajar: el viaje siempre va después de la aprobación. Esta ruta puede invertir ese orden. Las familias que dan por hecho que aquí se aplica la secuencia de la reagrupación a menudo esperan un permiso que no necesitaban.</p></div>
          <p>Qué pasaportes entran en cada fila lo fija la UE y no España, y la lista se modifica cada cierto tiempo, así que conviene comprobarlo en el momento y no memorizarlo. La <a href="https://europa.eu/youreurope/citizens/travel/entry-exit/non-eu-family/index_en.htm" target="_blank" rel="noreferrer">guía de la UE para familiares no comunitarios (en inglés)</a> cubre las obligaciones de gratuidad y tramitación rápida, y la página de <a href="https://administracion.gob.es/pag_Home/en/Tu-espacio-europeo/derechos-obligaciones/ciudadanos/residencia/obtencion-residencia/inscribir-familiares-no-ue.html" target="_blank" rel="noreferrer">inscripción de familiares no comunitarios (en inglés)</a> cubre la presentación una vez en España. Para el trámite en sí, consulta la <a href="/guides/es/eu-family/">guía de la tarjeta de familiar de ciudadano de la UE</a>.</p>`
        }),
        GuideSection({
...
pages.push({
  ...
  html: GuideLayout({
    ...
    sections: [
      ...
      GuideSection({
        id: "entryVisa",
        title: "Planning the entry step",
        children: `<p>Entry is really a sequencing question, and it belongs next to the "moving together vs joining later" decision above. For most families the practical question is not <em>whether</em> the non-EU relative can come, but whether they can travel first and file afterwards, or whether a consulate has to be involved before anyone books a flight. The answer turns on one variable: the relative's own nationality.</p>
        <table class="guide-table"><tbody>
          <tr><th>Situation</th><td><strong>What it means for sequencing</strong></td></tr>
          <tr><th>Passport allows visa-free short stays</th><td>The relative can normally arrive first and lodge the residence-card application after landing, without waiting on a consulate. Filing happens in Spain, at the immigration office for the province where the family will live, or at a designated police station if that province routes it that way. There is a three-month window from the day of entry, and the receipt issued on filing covers the person's stay while the card is produced.</td></tr>
          <tr><th>Passport requires a visa</th><td>A consulate step comes first, so the EU citizen's own registration and the relative's appointment need to be planned around it. This is still not an ordinary tourist-visa process: EU rules oblige member states to handle close relatives of EU citizens without charging a fee and on a faster track than standard applications.</td></tr>
          <tr><th>Relative already holds an EU-family card</th><td>A card already issued under this route by another member state removes the entry-visa question entirely, so the sequencing constraint disappears.</td></tr>
        </tbody></table>
        ${InfoBox({ title: "Why this differs from ordinary reunification", text: "On the standard reunification route a resident sponsor files in Spain and the relative then collects a visa abroad before travelling — travel always comes after approval. This route can invert that order. Families who assume the reunification sequence applies here often wait for permission they did not need." })}
        <p>Which passports fall into which row is set at EU level rather than by Spain, and the list is amended from time to time, so treat it as something to confirm rather than memorise. The <a href="https://europa.eu/youreurope/citizens/travel/entry-exit/non-eu-family/index_en.htm" target="_blank" rel="noreferrer">EU's guidance for non-EU family members</a> covers the fee and fast-track obligations, and <a href="https://administracion.gob.es/pag_Home/en/Tu-espacio-europeo/derechos-obligaciones/ciudadanos/residencia/obtencion-residencia/inscribir-familiares-no-ue.html" target="_blank" rel="noreferrer">registering non-EU family members</a> covers filing once in Spain. For the application itself, see the <a href="/guides/eu-family/">EU-family residence card guide</a>.</p>`
      }),
      GuideSection({

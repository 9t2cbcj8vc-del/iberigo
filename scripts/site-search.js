(function () {
  ...
  addStyle('link[data-iberigo-final-polish]', '/styles-final-visual-polish.css?v=20260815-final-polish-2', 'iberigoFinalPolish');
  ...
  (async () => {
    ...
    await loadScript('script[data-iberigo-final-polish]', '/scripts/final-visual-polish.js?v=20260815-final-polish-2', 'iberigoFinalPolish');
  })();
})();

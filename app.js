...
const translations = {
  en: {
    ...
    heroStats: "70+ guides · Updated September 2026 · Written from Alicante",
    ...
    calloutQuote: "Most guides say padrón takes a few days. In Torrevieja it took us 3.5 months — here's what actually happens.",
  ...
  es: {
    ...
    heroStats: "70+ guías · Actualizado en septiembre de 2026 · Escrito desde Alicante",
    ...
    calloutQuote: "Muchas guías dicen que el padrón tarda unos días. En Torrevieja tardamos 3,5 meses — esto es lo que realmente pasa.",

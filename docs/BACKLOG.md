...
- Documents Checklist source gap closed for Modelo 790-012 (directly verified) and EX-18 (links to the general Migraciones portal; the exact EX-18 form page couldn't be independently confirmed, documented rather than guessed) — Sprint 62. Apostille/legalisation source (Ministerio de Asuntos Exteriores) remains a smaller open gap.

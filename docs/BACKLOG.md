...
- Non-EU Citizen Roadmap drafted (Sprint 46, `/moving-to-spain/non-eu-citizens/`) — needs its own editorial + legal/immigration review pass before publication; 1 of its 7 route-specific sub-guides still doesn't exist (self-employed) — family-member-of-an-EU-citizen (Sprint 49), student (Sprint 52), work (Sprint 53), retirement (Sprint 54), family reunification (Sprint 55) and digital nomad (Sprint 56) are now drafted
...
- Dedicated sub-guide for the Non-EU roadmap's last remaining route card: self-employed (also needed for the digital nomad and work roadmaps' cross-links)
...
- Decide whether Start Here needs a dedicated remote-work/digital-nomad card, since one doesn't exist yet and Sprint 56 intentionally left Start Here unchanged
- Dedicated TIE guide

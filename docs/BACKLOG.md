...
- **Group 1 visual QA before publication** (from Sprint 65 human review — content acceptable for now, visual/design work required before any Group 1 page publishes):
  ...
  - **Next step: human visual QA sign-off on Group 1 against `docs/IBERIGO_GUIDE_SYSTEM_V1.md` §8** — Guide System v1 is applied and the QA pack is prepared, but Group 1's "Human review changes requested" status stands until a human approves the visuals; no page approved for publication, all pages remain noindex, nofollow

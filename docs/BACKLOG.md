...
- Non-EU Citizen Roadmap drafted (Sprint 46, `/moving-to-spain/non-eu-citizens/`) — needs its own editorial + legal/immigration review pass before publication; 2 of its 7 route-specific sub-guides still don't exist (digital nomad, self-employed) — family-member-of-an-EU-citizen (Sprint 49), student (Sprint 52), work (Sprint 53), retirement (Sprint 54) and family reunification (Sprint 55) are now drafted
...
- Dedicated sub-guides for the Non-EU roadmap's remaining route cards: digital nomad, self-employed

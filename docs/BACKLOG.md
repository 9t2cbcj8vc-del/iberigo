...
- **Group 1 visual QA before publication** (from Sprint 65 human review — content acceptable for now, visual/design work required before any Group 1 page publishes):
  ...
  - **Status: Visual changes applied — awaiting human visual re-check** — Group 1's "Human review changes requested" status stands until a human approves the visuals; no page approved for publication, all pages remain noindex, nofollow

...
- **Group 1 visual QA before publication** (from Sprint 65 human review — content acceptable for now, visual/design work required before any Group 1 page publishes):
  ...
  - **Next step: apply scoped Guide System v1 styles to Group 1 only after confirming selector safety** (implementation plan + rollback plan in the CSS scope doc; per-page QA checklist in the Guide System doc)
